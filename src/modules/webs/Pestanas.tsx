...
import Chips from "../videogames/tabs/Chips";
import {tipos} from "../../models/data/Datos";
        ...
        return (
            <div style={{marginBottom: '40px', backgroundColor: 'white'}}>
                ...
                <TabPanel value={this.state.pestanaActual} index={0}>
                    <Chips seleccionado={this.props.seleccionado} onFilterSubmit={this.props.onFilterSubmit} datos={tipos} pestana={0}/>
                </TabPanel>
            </div>
        );
    }
